...
void CAM_PriorityEncoder::Initialize(int _numInputBits, BufferDesignTarget _areaOptimizationLevel, 
	...
	Encoder.Initialize(numInputBits, areaOptimizationLevel, capLoad, resLoad, _inputParameter);
	...
	MMR.Initialize(numInputBits, areaOptimizationLevel, capNorInput, 0, _inputParameter/*TODO gate resistance */);
	initialized = true;
        CalculateArea();
        CalculateRC();
        CalculatePower();
